// To parse this data:
//
//   import { Convert, SercjGiftResponse } from "./file";
//
//   const sercjGiftResponse = Convert.toSercjGiftResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SercjGiftResponse {
    data:       Gift[];
...
export class Convert {
    public static toSercjGiftResponse(json: string): SercjGiftResponse {
        return cast(JSON.parse(json), r("SercjGiftResponse"));
    }

    public static sercjGiftResponseToJson(value: SercjGiftResponse): string {
        return JSON.stringify(uncast(value, r("SercjGiftResponse")), null, 2);
    }
}
